...
from Back.src.utils.progress_manager_auto_CrewAI import ProgressManagerAutoCrewAI
...
if __name__ == "__main__":
    ...
    #토론 관리 인스턴스 생성
    progress_manager = ProgressManagerAutoCrewAI(participant_factory=participant_factory,
                                        web_scrapper=web_scrapper,
                                        mongoDBConnection=mongodb_connection,
                                        topic_checker=topic_checker,
                                        vectorstore_handler=vectorstore_handler,
                                        generate_text_config=config["generate_text_config"],api_key=AI_API_KEY["GEMINI"])
    user = {
    ...
    progress_manager.create_progress("debate", participant=participants)
