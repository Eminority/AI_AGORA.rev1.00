...
class Debate_3(Progress):
    ...
    def __init__(self, participant: dict, generate_text_config: dict, data: dict = None):
        ...
        self.claim_prompt = PromptTemplate(
            ...
            template="""
            [SYSTEM: 당신은 {topic} 주제에 대한 토론 참여하고 있습니다. 당신의 역할은 이 주장에 {position} 입장에서 논증하는 것입니다. 반드시 한국어로만 말해야 합니다.]
            ### **진행 방식:**  
            - **반드시 한국어로만 말해야 합니다.**  
        ...
        self.argument_prompt = PromptTemplate(
            ...
            template="""  
            [SYSTEM: 당신은 {topic} 주제에 대한 토론에 참여하고 있습니다. 역할은 {position}의 입장에서 상대의 주장을 반박하는 것입니다. 반드시 한국어로만 말해야 합니다.]
            ### **진행 방식:**  
            - **반드시 한국어로만 말해야 합니다.**  
